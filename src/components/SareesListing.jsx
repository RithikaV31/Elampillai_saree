...
export default function SareesListing({ cart, wishlist, onAddToCart, onToggleWishlist }) {
  ...
  /* ================= ONLY SINGLE SAREES ================= */
  const singleProducts = PRODUCTS.filter((p) => p.type !== "combo");

  /* ================= FILTER ================= */
  const filtered = singleProducts.filter((p) => {
      ...
      <div className="sl-container">
        ...
        <aside className={`sl-filter ${showFilters ? "open" : ""}`}>
          ...
          <div className="filter-group">
            ...
            {[...new Set(singleProducts.map(p => p.category))].map((c) => (
          ...
          <div className="filter-group">
            ...
            {[...new Set(singleProducts.map(p => p.occasion))].map((o) => (
