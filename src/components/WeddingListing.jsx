...
export default function WeddingListing({ cart, wishlist, onAddToCart, onToggleWishlist }) {
  ...
  /* ================= FILTER ONLY WEDDING ================= */
  const categoryProducts = PRODUCTS.filter((p) => p.category === "Wedding");
  ...
  return (
    <div className="sl-page">
      <style>{`
        ...
        .sl-header {
          background: #fff7ed; /* Warm wedding theme background */
          padding: 4rem 1rem;
          text-align: center;
          margin-bottom: 3rem;
        }
      ...
      <div className="sl-header">
        ...
        <p>Expertly crafted sarees to make your special moments unforgettable.</p>
      </div>
